...
public class HSearchTableVString implements IHSearchTable {
    ...
    ///////////////////////////////////////////////////////////////////	
    CellV2<String> table = null;
    String defaultValue = null;

    public HSearchTableVString(String defaultValue) {
    	this.table = createBlankTable(defaultValue);
    	this.defaultValue = defaultValue;
    }

    public CellV2<String> createBlankTable(String defaultValue) {
        return new CellV2<String>(PositionalBytesString.getInstance(defaultValue));
    }
    ...
    public void parse(byte[] data, Cell2Visitor<Integer, String> visitor) throws IOException {
		CellV2<String> cellv2 = createBlankTable(this.defaultValue);
