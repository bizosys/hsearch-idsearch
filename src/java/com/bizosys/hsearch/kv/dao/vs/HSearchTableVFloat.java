...
public class HSearchTableVFloat implements IHSearchTable {
    ...
    ///////////////////////////////////////////////////////////////////	
    CellV2<Float> table = null;
    Float defaultValue = null;

    public HSearchTableVFloat(float defaultValue) {
    	this.table = createBlankTable(defaultValue);
    	this.defaultValue = defaultValue;
    }

    public CellV2<Float> createBlankTable(float defaultValue) {
        return new CellV2<Float>(PositionalBytesFloat.getInstance(defaultValue));
    }
    ...
    public void parse(byte[] data, Cell2Visitor<Integer, Float> visitor) throws IOException {
		CellV2<Float> cellv2 = createBlankTable(this.defaultValue);
