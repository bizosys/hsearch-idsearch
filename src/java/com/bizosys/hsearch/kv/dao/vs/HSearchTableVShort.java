...
public class HSearchTableVShort implements IHSearchTable {
    ...
    ///////////////////////////////////////////////////////////////////	
    CellV2<Short> table = null;
    Short defaultValue = null;

    public HSearchTableVShort(short defaultValue) {
    	this.table = createBlankTable(defaultValue);
    	this.defaultValue = defaultValue;
    }

    public CellV2<Short> createBlankTable(short defaultValue) {
        return new CellV2<Short>(PositionalBytesShort.getInstance(defaultValue));
    }
	...
	public void parse(byte[] data, Cell2Visitor<Integer, Short> visitor) throws IOException {
		CellV2<Short> cellv2 = createBlankTable(this.defaultValue);
