...
public class HSearchTableVLong implements IHSearchTable {
    ...
    ///////////////////////////////////////////////////////////////////	
    CellV2<Long> table = null;
    Long defaultValue = null;
    
    public HSearchTableVLong(long defaultValue) {
    	this.table = createBlankTable(defaultValue);
    	this.defaultValue = defaultValue;
    }

    public CellV2<Long> createBlankTable(long defaultValue) {
        return new CellV2<Long>(PositionalBytesLong.getInstance(defaultValue));
    }
    ...
    public void parse(byte[] data, Cell2Visitor<Integer, Long> cell2Visitor) throws IOException {
		CellV2<Long> cellv2 = createBlankTable(this.defaultValue);
		cellv2.data = new BytesSection(data);
		cellv2.process(cell2Visitor);
    }
