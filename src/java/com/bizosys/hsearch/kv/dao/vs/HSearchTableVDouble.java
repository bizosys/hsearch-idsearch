...
import com.bizosys.hsearch.byteutils.vs.PositionalBytesDouble;
...
public class HSearchTableVDouble implements IHSearchTable {
    ...
    ///////////////////////////////////////////////////////////////////	
    CellV2<Double> table = null;
    Double defaultValue = null;

    public HSearchTableVDouble(double defaultValue) {
    	this.table = createBlankTable(defaultValue);
    	this.defaultValue = defaultValue;
    }

    public CellV2<Double> createBlankTable(double defaultValue) {
        return new CellV2<Double>(PositionalBytesDouble.getInstance(defaultValue));
    }
    ...
    public void parse(byte[] data, Cell2Visitor<Integer, Double> visitor) throws IOException {
		CellV2<Double> cellv2 = createBlankTable(this.defaultValue);
