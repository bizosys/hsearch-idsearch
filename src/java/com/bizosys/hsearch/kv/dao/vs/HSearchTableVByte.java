...
public class HSearchTableVByte implements IHSearchTable {
    ...
    ///////////////////////////////////////////////////////////////////	
    CellV2<Byte> table = null;
    Byte defaultValue = null;

    public HSearchTableVByte(byte defaultValue) {
    	this.table = createBlankTable(defaultValue);
    	this.defaultValue = defaultValue;
    }

    public CellV2<Byte> createBlankTable(byte defaultValue) {
        return new CellV2<Byte>(PositionalBytesByte.getInstance(defaultValue));
    }
    ...
    public void parse(byte[] data, Cell2Visitor<Integer, Byte> visitor) throws IOException {
		CellV2<Byte> cellv2 = createBlankTable(this.defaultValue);
