...
public class IndexFieldBoolean {
	...
	public static final Cell2<Integer,Boolean> createBlankTable() {
		return new Cell2<Integer,Boolean>(SortedBytesInteger.getInstance(),SortedBytesBoolean.getInstance());
	}
