...
public class IndexFieldInteger {
	...
	public static final Cell2<Integer,Integer> createBlankTable() {
		return new Cell2<Integer,Integer>(SortedBytesInteger.getInstance(),SortedBytesInteger.getInstance());
	}
