...
public class KVIndexer {
	...
	public static final int MF2HB = 3;
	public static final int MF2HF = 4;
	public static final int MF2MF = 5;
	...
	static {
		...
		JobTypeMapping.put("MF2HB", MF2HB);
		JobTypeMapping.put("MF2HF", MF2HF);
		JobTypeMapping.put("MF2MF", MF2MF);
