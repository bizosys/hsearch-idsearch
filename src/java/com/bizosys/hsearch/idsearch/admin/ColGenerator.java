...
/**
 * This class is used to generate the value object class 
 * based on the schema which is a implementation class of {@link KVRowI}.  
 * 
 *
 */
public class ColGenerator {
	...
	/**
	 * This method generates a value object class.
	 * @param fm
	 * @param path
	...
	public static void generate(final FieldMapping fm , final String path, final String completeClassName) throws IOException {
		...
		FileWriterUtil.downloadToFile(template.getBytes(),new File(pathPrefix + className + ".java") );
	}

	/**
	 * This return a content of a given file as String.
	 * @param fileName
	...
	/**
	 * Given a valid input parameters creates a VO class.
	 * @param fm
	 * @param outputPath
	 * @param completeClassName
	 */
	...
	public static void main(String[] args) throws IOException, ParseException {
		if (args.length != 3) {
			System.err.println("ColGenerator schemaFile create-path class-name");
			return;
		}
		
		String schemaFile = args[0];
		String valueObjectPath = args[1];
		String valueObjectClassName = args[2];
		
		FieldMapping fm = FieldMapping.getInstance(schemaFile);
