...
ALPHANUM   = ({ALetter}|[:digit:])+
// dashedwords
// use a post-filter to remove dots
RELATEDTERM    =  ({ALPHANUM} "-" {ALPHANUM}){1,4}
...
{RELATEDTERM}                                                  { return RELATEDTERM;}
{PHRASE}	                                                   { zzStartRead = zzStartRead + 1;zzMarkedPos = zzMarkedPos - 1;return PHRASE;}
